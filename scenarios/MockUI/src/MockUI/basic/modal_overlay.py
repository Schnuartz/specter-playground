...
from .ui_consts import BLACK_HEX, theme_color
...
class ModalOverlay:
    ...
    def __init__(self, bg_opa=lv.OPA.TRANSP, bg_color=None):
        ...
        resolved_color = theme_color(BLACK_HEX) if bg_color is None else lv.color_hex(bg_color)
        self.overlay.set_style_bg_color(resolved_color, 0)
