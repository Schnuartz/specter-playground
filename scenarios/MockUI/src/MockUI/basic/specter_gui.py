...
_REFERENCE_SCREEN_IDS = (
    ...
    "scan", "sd_card", "smartcard", "store_to_smartcard", "import_from_smartcard",
    "clear_from_smartcard", "store_to_sd", "import_from_sd", "clear_from_sd",
    "signing", "settings", "security_settings",
