...
_MENU_CONTEXT = {
    ...
    "security_settings": Context.DEVICE,
    "interfaces":        Context.DEVICE,
    "language_settings": Context.DEVICE,
    "theme_settings":    Context.DEVICE,
    "import_language":   Context.DEVICE,
    "import_theme":      Context.DEVICE,
    "wipe_device":       Context.DEVICE,
    "firmware_info":     Context.DEVICE,
    "sd_card":           Context.DEVICE,
    "smartcard":         Context.DEVICE,
    "add_seed":          Context.ADD_SEED,
    "generate_seed":     Context.ADD_SEED,
    "enter_seed_words":  Context.ADD_SEED,
    "manage_seedphrase": Context.SEED,
    "seed_management":   Context.SEED,
    "seed_detail":       Context.SEED,
    "set_passphrase":    Context.SEED,
    "show_seed_words":   Context.SEED,
    "store_to_smartcard": Context.SEED,
    "import_from_smartcard": Context.ADD_SEED,
    "clear_from_smartcard": Context.SEED,
    "store_to_sd":       Context.SEED,
    "import_from_sd":    Context.ADD_SEED,
    "clear_from_sd":     Context.SEED,
    "add_wallet":        Context.ADD_WALLET,
    "manage_wallet":     Context.WALLET,
    "wallet_info":       Context.WALLET,
    "wallet_menu":       Context.WALLET,
    "wallet_details":    Context.WALLET,
    "rename_wallet":     Context.WALLET,
    "connect_app":       Context.WALLET,
    "export":            Context.WALLET,
    "receive":           Context.WALLET,
    "address_qr":        Context.WALLET,
    "signing":           Context.WALLET,
    "xpub_export":       Context.WALLET,
}
